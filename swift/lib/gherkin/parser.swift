...
class Parser {
  ...
  func matchToken(state: Int, token: Token, context: ParserContext) throws -> Int {
    ...
    // Start
    func matchTokenAt0(token: Token, context: ParserContext) throws -> Int {
    ...
    func matchTokenAt1(token: Token, context: ParserContext) throws -> Int {
      if matchTagLine(context, token: token) {
        startRule(context, ruleType: .Tags);
        build(context, token: token);
            return 2
    ...
    func matchTokenAt2(token: Token, context: ParserContext) throws -> Int {
      if matchTagLine(context, token: token) {
        build(context, token: token);
            return 2
          }
    ...
    func matchTokenAt3(token: Token, context: ParserContext) throws -> Int {
    ...
    func matchTokenAt4(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
    ...
    func matchTokenAt5(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
        endRule(context, ruleType: .Feature_Header);
        build(context, token: token);
            return 28
    ...
    func matchTokenAt6(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
    ...
    func matchTokenAt7(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
        endRule(context, ruleType: .Description);
        endRule(context, ruleType: .Background);
        build(context, token: token);
    ...
    func matchTokenAt8(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
        endRule(context, ruleType: .Background);
        build(context, token: token);
            return 28
    ...
    func matchTokenAt9(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
    ...
    func matchTokenAt10(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
    ...
    func matchTokenAt11(token: Token, context: ParserContext) throws -> Int {
      if matchTagLine(context, token: token) {
        build(context, token: token);
            return 11
          }
    ...
    func matchTokenAt12(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
    ...
    func matchTokenAt13(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
        endRule(context, ruleType: .Description);
        endRule(context, ruleType: .Scenario);
        endRule(context, ruleType: .Scenario_Definition);
    ...
    func matchTokenAt14(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
        endRule(context, ruleType: .Scenario);
        endRule(context, ruleType: .Scenario_Definition);
        build(context, token: token);
    ...
    func matchTokenAt15(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
        endRule(context, ruleType: .Step);
        endRule(context, ruleType: .Scenario);
        endRule(context, ruleType: .Scenario_Definition);
    ...
    func matchTokenAt16(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
        endRule(context, ruleType: .DataTable);
        endRule(context, ruleType: .Step);
        endRule(context, ruleType: .Scenario);
    ...
    func matchTokenAt17(token: Token, context: ParserContext) throws -> Int {
      if matchEmpty(context, token: token) {
        build(context, token: token);
            return 17
          }
    ...
    func matchTokenAt18(token: Token, context: ParserContext) throws -> Int {
      if matchComment(context, token: token) {
        endRule(context, ruleType: .Description);
        build(context, token: token);
            return 19
    ...
    func matchTokenAt19(token: Token, context: ParserContext) throws -> Int {
      if matchComment(context, token: token) {
        build(context, token: token);
            return 19
          }
    ...
    func matchTokenAt20(token: Token, context: ParserContext) throws -> Int {
      if matchTableRow(context, token: token) {
        startRule(context, ruleType: .DataTable);
        build(context, token: token);
            return 21
    ...
    func matchTokenAt21(token: Token, context: ParserContext) throws -> Int {
      if matchTableRow(context, token: token) {
        build(context, token: token);
            return 21
          }
    ...
    func matchTokenAt22(token: Token, context: ParserContext) throws -> Int {
      if matchTagLine(context, token: token) {
        build(context, token: token);
            return 22
          }
    ...
    func matchTokenAt23(token: Token, context: ParserContext) throws -> Int {
      if matchEmpty(context, token: token) {
        build(context, token: token);
            return 23
          }
    ...
    func matchTokenAt24(token: Token, context: ParserContext) throws -> Int {
      if matchComment(context, token: token) {
        endRule(context, ruleType: .Description);
        build(context, token: token);
            return 25
    ...
    func matchTokenAt25(token: Token, context: ParserContext) throws -> Int {
      if matchComment(context, token: token) {
        build(context, token: token);
            return 25
          }
    ...
    func matchTokenAt26(token: Token, context: ParserContext) throws -> Int {
      if matchTableRow(context, token: token) {
        build(context, token: token);
            return 27
          }
    ...
    func matchTokenAt27(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
      ...
      if matchTagLine(context, token: token) {
        if lookAhead0(context, currentToken: token) {
        endRule(context, ruleType: .Examples);
        endRule(context, ruleType: .Examples_Definition);
        startRule(context, ruleType: .Examples_Definition);
        startRule(context, ruleType: .Tags);
    ...
    func matchTokenAt29(token: Token, context: ParserContext) throws -> Int {
      if matchDocStringSeparator(context, token: token) {
        build(context, token: token);
            return 30
          }
    ...
    func matchTokenAt30(token: Token, context: ParserContext) throws -> Int {
      if matchStepLine(context, token: token) {
    ...
    func matchTokenAt31(token: Token, context: ParserContext) throws -> Int {
      if matchDocStringSeparator(context, token: token) {
        build(context, token: token);
            return 32
          }
    ...
    func matchTokenAt32(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
        endRule(context, ruleType: .DocString);
        endRule(context, ruleType: .Step);
        endRule(context, ruleType: .Scenario);
    ...
    func matchTokenAt33(token: Token, context: ParserContext) throws -> Int {
      if matchDocStringSeparator(context, token: token) {
        build(context, token: token);
            return 34
          }
    ...
    func matchTokenAt34(token: Token, context: ParserContext) throws -> Int {
      if matchEOF(context, token: token) {
        endRule(context, ruleType: .DocString);
        endRule(context, ruleType: .Step);
        endRule(context, ruleType: .Background);
      ...
      func lookAhead0(context: ParserContext, currentToken: Token) -> Bool {
        currentToken.detach()
        var token: Token
        var queue: [Token]
        ...
        repeat {
          ...
          if (false || matchExamplesLine(context, token: token)) {
            match = true
            break
          }
