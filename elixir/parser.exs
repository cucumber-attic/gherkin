...
defmodule Gherkin.Parser do
  ...
  def parse(token_scanner, token_matcher=TokenMatcher.new) do
  ...
  def start_rule(rule_type) do
    # handle_ast_error(context) do
      # @ast_builder.start_rule(rule_type)
    # end
  end

  def end_rule(rule_type) do
    # handle_ast_error(context) do
  ...
  def read_token(token_queue, token_scanner_state) do
    if Enum.any?(token_queue) do
      token = hd(token_queue)
      new_token_queue = tl(token_queue)
      {token, token_scanner_state, new_token_queue}
    else
      {token, new_token_scanner_state} = TokenScanner.read(token_scanner_state)
      {token, new_token_scanner_state, token_queue}
    end
  ...
  def match_Comment(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_TagLine(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_FeatureLine(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_BackgroundLine(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_ScenarioLine(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_ScenarioOutlineLine(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_ExamplesLine(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_StepLine(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_DocStringSeparator(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_TableRow(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_Language(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_Other(context, token) do
    return false if token.eof?
    return handle_external_error(context, false) do
  ...
  def match_token(state, token, context) do
    case state
    when 0
  ...
  # Start
  def match_token_at_0(token, context) do
  ...
  def match_token_at_1(token, context) do
    if match_TagLine(context, token)
        start_rule(context, :Tags);
        build(context, token);
      return 2
  ...
  def match_token_at_2(token, context) do
    if match_TagLine(context, token)
        build(context, token);
      return 2
    end
  ...
  def match_token_at_3(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_4(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_5(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Feature_Header);
        end_rule(context, :Feature);
        build(context, token);
  ...
  def match_token_at_6(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_7(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Description);
        end_rule(context, :Background);
        end_rule(context, :Feature);
  ...
  def match_token_at_8(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Background);
        end_rule(context, :Feature);
        build(context, token);
  ...
  def match_token_at_9(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_10(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_11(token, context) do
    if match_TagLine(context, token)
        build(context, token);
      return 11
    end
  ...
  def match_token_at_12(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_13(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Description);
        end_rule(context, :Scenario);
        end_rule(context, :Scenario_Definition);
  ...
  def match_token_at_14(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Scenario);
        end_rule(context, :Scenario_Definition);
        end_rule(context, :Feature);
  ...
  def match_token_at_15(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Step);
        end_rule(context, :Scenario);
        end_rule(context, :Scenario_Definition);
  ...
  def match_token_at_16(token, context) do
    if match_EOF(context, token)
        end_rule(context, :DataTable);
        end_rule(context, :Step);
        end_rule(context, :Scenario);
  ...
  def match_token_at_17(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_18(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Description);
        end_rule(context, :ScenarioOutline);
        end_rule(context, :Scenario_Definition);
  ...
  def match_token_at_19(token, context) do
    if match_EOF(context, token)
        end_rule(context, :ScenarioOutline);
        end_rule(context, :Scenario_Definition);
        end_rule(context, :Feature);
  ...
  def match_token_at_20(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Step);
        end_rule(context, :ScenarioOutline);
        end_rule(context, :Scenario_Definition);
  ...
  def match_token_at_21(token, context) do
    if match_EOF(context, token)
        end_rule(context, :DataTable);
        end_rule(context, :Step);
        end_rule(context, :ScenarioOutline);
  ...
  def match_token_at_22(token, context) do
    if match_TagLine(context, token)
        build(context, token);
      return 22
    end
  ...
  def match_token_at_23(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_24(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Description);
        end_rule(context, :Examples);
        end_rule(context, :Examples_Definition);
  ...
  def match_token_at_25(token, context) do
    if match_EOF(context, token)
        end_rule(context, :Examples);
        end_rule(context, :Examples_Definition);
        end_rule(context, :ScenarioOutline);
  ...
  def match_token_at_26(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_28(token, context) do
    if match_DocStringSeparator(context, token)
        build(context, token);
      return 29
    end
  ...
  def match_token_at_29(token, context) do
    if match_EOF(context, token)
  ...
  def match_token_at_30(token, context) do
    if match_DocStringSeparator(context, token)
        build(context, token);
      return 31
    end
  ...
  def match_token_at_31(token, context) do
    if match_EOF(context, token)
        end_rule(context, :DocString);
        end_rule(context, :Step);
        end_rule(context, :Scenario);
  ...
  def match_token_at_32(token, context) do
    if match_DocStringSeparator(context, token)
        build(context, token);
      return 33
    end
  ...
  def match_token_at_33(token, context) do
    if match_EOF(context, token)
        end_rule(context, :DocString);
        end_rule(context, :Step);
        end_rule(context, :Background);
  ...
  def lookahead_0(context, currentToken) do
    currentToken.detach
    token = nil
    queue = []
    match = false
  ...
  def handle_ast_error(context, &action) do
    handle_external_error(context, true, &action)
  end

  def handle_external_error(context, default_value, &action) do
