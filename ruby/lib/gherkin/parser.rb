...
module Gherkin
  ...
  class Parser
    ...
    def match_token(state, token, context)
      case state
      when 0
        newState = match_token_at_0(token, context)
      when 1
        newState = match_token_at_1(token, context)
      when 2
        newState = match_token_at_2(token, context)
      when 3
        newState = match_token_at_3(token, context)
      when 4
        newState = match_token_at_4(token, context)
      when 5
        newState = match_token_at_5(token, context)
      when 6
        newState = match_token_at_6(token, context)
      when 7
        newState = match_token_at_7(token, context)
      when 8
        newState = match_token_at_8(token, context)
      when 9
        newState = match_token_at_9(token, context)
      when 10
        newState = match_token_at_10(token, context)
      when 11
        newState = match_token_at_11(token, context)
      when 12
        newState = match_token_at_12(token, context)
      when 13
        newState = match_token_at_13(token, context)
      when 14
        newState = match_token_at_14(token, context)
      when 15
        newState = match_token_at_15(token, context)
      when 16
        newState = match_token_at_16(token, context)
      when 17
        newState = match_token_at_17(token, context)
      when 18
        newState = match_token_at_18(token, context)
      when 19
        newState = match_token_at_19(token, context)
      when 20
        newState = match_token_at_20(token, context)
      when 21
        newState = match_token_at_21(token, context)
      when 22
        newState = match_token_at_22(token, context)
      when 23
        newState = match_token_at_23(token, context)
      when 24
        newState = match_token_at_24(token, context)
      when 25
        newState = match_token_at_25(token, context)
      when 26
        newState = match_token_at_26(token, context)
      when 27
        newState = match_token_at_27(token, context)
      when 28
        newState = match_token_at_28(token, context)
      when 29
        newState = match_token_at_29(token, context)
      when 30
        newState = match_token_at_30(token, context)
      when 31
        newState = match_token_at_31(token, context)
      when 33
        newState = match_token_at_33(token, context)
      when 34
        newState = match_token_at_34(token, context)
      when 35
        newState = match_token_at_35(token, context)
      when 36
        newState = match_token_at_36(token, context)
      when 37
        newState = match_token_at_37(token, context)
      when 38
        newState = match_token_at_38(token, context)
      when 39
        newState = match_token_at_39(token, context)
      when 40
        newState = match_token_at_40(token, context)
      when 41
        newState = match_token_at_41(token, context)
      else
