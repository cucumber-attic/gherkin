...
- (id)initWithTokenScanner:(id<GHTokenScannerProtocol>)theTokenScanner
{
    return [self initWithTokenScanner: theTokenScanner tokenMatcher: [[GHTokenMatcher alloc] init]];
}

- (id)initWithTokenScanner:(id<GHTokenScannerProtocol>)theTokenScanner tokenMatcher:(id<GHTokenMatcherProtocol>)theTokenMatcher
{
...
{
    [self handleExternalErrorWithContext: theContext actionBlock: ^() { theActionBlock(); return YES; } defaultValue: nil];
}
